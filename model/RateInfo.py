...
class RateInfo:
    ...
    def __init__(self, gold22, gold24, silver, date, last_updated_time, current_time):
    ...
    def __str__(self):
        return "RateInfo: [date: " + str(self.__date) + ", gold22: " + str(self.__gold22) + ", gold24: " + str(self.__gold24) + ", silver: " + str(self.__silver) + ", lastUpdated: " + str(self.__last_updated_time) + ", currentTime: " + str(self.__current_time) + "]"
